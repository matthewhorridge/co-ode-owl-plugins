...
public class OPLActionsParser implements OPLActionsParserConstants {
    ...
    public static void parse(String inString, Map ns2uri,
            OWLOntologyManager manager, SelectStatementResult selectResult)
    ...
    final public void Input(OWLEntity owlentity, Map ns2uri,
            OWLOntologyManager manager, SelectStatementResult selectResult)
            throws ParseException {
        Token add = null;
        Token remove = null;
    ...
    final public OWLAxiom Axiom(OWLEntity owlentity, Map ns2uri,
            OWLOntologyManager manager, SelectStatementResult selectResult)
            throws ParseException {
        OWLAxiom axiom = null;
        if (jj_2_3(2)) {
    ...
    final public OWLAxiom owlannotation(OWLEntity owlentity,
        ...
        annot = factory.getOWLAnnotation(factory.getRDFSLabel(),
                factory.getOWLLiteral(tokenAnnotValue.image));
        axiom = factory.getOWLAnnotationAssertionAxiom(owlentity.getIRI(),
                annot);
        {
            if (true) {
                return axiom;
    ...
    final public OWLAxiom owlsubclassof(OWLEntity owlentity, Map ns2uri,
            OWLOntologyManager manager, SelectStatementResult selectResult)
            throws ParseException {
        ...
        if (superclass != null) {
            axiom = factory.getOWLSubClassOfAxiom(
                    (OWLClassExpression) owlentity, superclass);
        }
        {
            if (true) {
                return axiom;
    ...
    final public OWLAxiom owlequivalentclass(OWLEntity owlentity, Map ns2uri,
            OWLOntologyManager manager, SelectStatementResult selectResult)
            throws ParseException {
        OWLClassExpression equivalentclass;
        jj_consume_token(Var);
        jj_consume_token(EQUIVALENTTO);
        equivalentclass = ClassDescription(owlentity, ns2uri, manager,
                selectResult);
        OWLAxiom axiom = null;
        OWLDataFactory factory = manager.getOWLDataFactory();
        HashSet equivSet = new HashSet();
        equivSet.add(owlentity);
    ...
    final public OWLAxiom owlsubpropertyof(OWLEntity owlentity, Map ns2uri,
            OWLOntologyManager manager, SelectStatementResult selectResult)
            throws ParseException {
        ...
        OWLAxiom axiom = null;
        OWLDataFactory factory = manager.getOWLDataFactory();
        axiom = factory.getOWLSubObjectPropertyOfAxiom(
                (OWLObjectProperty) owlentity, superproperty);
        {
            if (true) {
                return axiom;
            }
    ...
    final public OWLClassExpression ClassDescription(OWLEntity owlentity,
            Map ns2uri, OWLOntologyManager manager,
            SelectStatementResult selectResult) throws ParseException {
        OWLClassExpression owldescription;
    ...
    final public OWLClassExpression And(OWLEntity owlentity, Map ns2uri,
            OWLOntologyManager manager, SelectStatementResult selectResult)
            throws ParseException {
        OWLClassExpression description;
        OWLClassExpression totaldescription = null;
    ...
    final public OWLClassExpression Or(OWLEntity owlentity, Map ns2uri,
            OWLOntologyManager manager, SelectStatementResult selectResult)
            throws ParseException {
        OWLClassExpression description;
        OWLClassExpression totaldescription;
        description = NonNaryBooleanDescription(owlentity, ns2uri, manager,
                selectResult);
        totaldescription = description;
        label_2: while (true) {
            if (jj_2_8(2)) {
    ...
    final public OWLClassExpression NonNaryBooleanDescription(
            OWLEntity owlentity, Map ns2uri, OWLOntologyManager manager,
            SelectStatementResult selectResult) throws ParseException {
        OWLClassExpression description;
        if (jj_2_9(2)) {
            description = ObjectPropertyRestriction(owlentity, ns2uri, manager,
                    selectResult);
        } else if (jj_2_10(2)) {
            description = Not(owlentity, ns2uri, manager, selectResult);
        } else if (jj_2_11(2)) {
            description = NamedClassOrNestedDescription(owlentity, ns2uri,
    ...
    final public OWLClassExpression Not(OWLEntity owlentity, Map ns2uri,
            OWLOntologyManager manager, SelectStatementResult selectResult)
            throws ParseException {
        OWLClassExpression description;
        jj_consume_token(NOT);
        description = NamedClassOrNestedDescription(owlentity, ns2uri, manager,
                selectResult);
        OWLDataFactory factory = manager.getOWLDataFactory();
        if (description != null) {
    ...
    final public OWLClassExpression ObjectPropertyRestriction(
            OWLEntity owlentity, Map ns2uri, OWLOntologyManager manager,
            SelectStatementResult selectResult) throws ParseException {
        OWLClassExpression description;
        if (jj_2_12(2)) {
            description = OWLObjectSomeRestriction(owlentity, ns2uri, manager,
                    selectResult);
        } else if (jj_2_13(2)) {
            description = OWLObjectAllRestriction(owlentity, ns2uri, manager,
                    selectResult);
        } else {
            jj_consume_token(-1);
            throw new ParseException();
    ...
    final public OWLClassExpression OWLObjectAllRestriction(
            OWLEntity owlentity, Map ns2uri, OWLOntologyManager manager,
            SelectStatementResult selectResult) throws ParseException {
        ...
        filler = NamedClassOrNestedDescription(owlentity, ns2uri, manager,
                selectResult);
        OWLDataFactory factory = manager.getOWLDataFactory();
        if (filler != null) {
    ...
    final public OWLClassExpression OWLObjectSomeRestriction(
            OWLEntity owlentity, Map ns2uri, OWLOntologyManager manager,
            SelectStatementResult selectResult) throws ParseException {
        OWLClassExpression description = null;
        OWLObjectProperty property;
    ...
    final public OWLClassExpression NamedClassOrNestedDescription(
        ...
        OWLClassExpression description;
        if (jj_2_14(2)) {
            description = owlresolvedclass(owlentity, ns2uri, manager,
                    selectResult);
        } else if (jj_2_15(2)) {
            description = NestedClassDescription(owlentity, ns2uri, manager,
                    selectResult);
        } else {
            jj_consume_token(-1);
            throw new ParseException();
    ...
    final public OWLClassExpression NestedClassDescription(OWLEntity owlentity,
            Map ns2uri, OWLOntologyManager manager,
            SelectStatementResult selectResult) throws ParseException {
        OWLClassExpression description;
    ...
    final public OWLClassExpression owlresolvedclass(OWLEntity owlentity,
            Map<String, IRI> ns2uri, OWLOntologyManager manager,
            SelectStatementResult selectResult) throws ParseException {
        ...
        if (nonresolvedgroup != null) {
            ...
            IRI nsURI = ns2uri.get(NS);
            if (nsURI != null) {
                int groupnumber = Integer.parseInt(nonresolvedgroup.image
                        .split("RG")[1].substring(0, 1));
                Matcher matcher = selectResult.regexpmatcher();
                String ClassName = getGroupContent(matcher, groupnumber);
                IRI ClassURI = IRI.create(nsURI + "#" + ClassName);
                description = factory.getOWLClass(ClassURI);
            }
            // description=
            // (OWLClassExpression)factory.getOWLClass(URI.create("http://www.gong.manchester.ac.uk/opl.owl#spain"));
            ...
            if (nsURI != null) {
                ...
                int groupnumber = Integer.parseInt(group.split("RG")[1]
                        .substring(0, 1));
                Matcher matcher = selectResult.regexpmatcher();
                String ClassName = getGroupContent(matcher, groupnumber);
                OWLOntology ontology = manager.getOntology(nsURI);
                description = getClassByLabel(ontology, ClassName);
            }
        } else {
    ...
    final public OWLObjectProperty resolvedOWLObjectProperty(
            OWLEntity owlentity, Map<String, IRI> ns2uri,
            OWLOntologyManager manager) throws ParseException {
        ...
        if (nsURI != null) {
            ...
            IRI PropURI = IRI.create(nsURI + "#" + PropName);
            OWLDataFactory factory = manager.getOWLDataFactory();
    ...
    final public String getGroupContent(Matcher matcher, int groupnumber)
            throws ParseException {
        String content = null;
        if (matcher != null) {
            ...
            for (int i = 1; i <= groups; i++) {
                if (groupnumber == i) {
                    ...
                    // System.out.println( groupnumber +" ingroup " +
                    // matcher.group(i));
                }
            }
        }
    ...
    final public OWLClass getClassByLabel(OWLOntology ontology, String label)
            throws ParseException {
        ...
        for (OWLClass cls : ontology.getClassesInSignature()) {
            ...
            for (OWLAnnotation annotAxiom : EntitySearcher.getAnnotations(
                ...
                finalLabel = ((OWLLiteral) annotAxiom.getValue()).getLiteral();
            }
    ...
    final private boolean jj_3R_6() {
        ...
        if (jj_scan_token(SUBPROPERTYOF)) {
            return true;
        }
        return false;
    }
