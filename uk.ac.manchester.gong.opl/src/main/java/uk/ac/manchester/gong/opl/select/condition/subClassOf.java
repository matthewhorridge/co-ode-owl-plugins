...
public class subClassOf implements MatchingCondition {

    private OWLOntologyManager manager;
    private Map<String, IRI> ns2uri;

    public subClassOf(OWLOntologyManager manager, Map<String, IRI> ns2uri) {
    ...
    public SelectStatementResultSet match(String SelectExpression,OWLOntology ontology) {
        ...
        Set<OWLClass> subClses = reasoner.getSubClasses(owldescription, false)
                .getFlattened();
