...
public class InstantiatedPatternArgumentCompleter {
	private String name;
	...
	public InstantiatedPatternArgumentCompleter(String name,
		...
		this.keyListener = new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				InstantiatedPatternArgumentCompleter.this.processKeyPressed(e);
			}
			...
			public void keyReleased(KeyEvent e) {
				if (e.getKeyCode() != KeyEvent.VK_UP
					...
					if (InstantiatedPatternArgumentCompleter.this.popupWindow
							.isVisible()
							&& !InstantiatedPatternArgumentCompleter.this.lastTextUpdate
									.equals(InstantiatedPatternArgumentCompleter.this.textComponent
											.getText())) {
						InstantiatedPatternArgumentCompleter.this.lastTextUpdate = InstantiatedPatternArgumentCompleter.this.textComponent
								.getText();
						InstantiatedPatternArgumentCompleter.this
								.updatePopup(InstantiatedPatternArgumentCompleter.this
										.getMatches());
					}
				}
			}
	...
	private List<? extends Object> getMatches() {
		String prefix = "$" + this.name + "(";
		PatternParser parser = ParserFactory.initParser(prefix
