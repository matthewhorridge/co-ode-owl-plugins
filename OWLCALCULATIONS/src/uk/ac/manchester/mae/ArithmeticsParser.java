...
public class ArithmeticsParser/* @bgen(jjtree) */implements
	...
	static String PropertyURI() throws ParseException {
		...
		while (true) {
			...
			if (t.kind == EXCLAMATION || t.image.startsWith("[")
					|| t.kind == CLOSEDCURLYBRACKET || t.kind == BINDINGEND
					|| t.image.startsWith("{") || t.image.startsWith(">")
					|| t.kind == EOF) {
				break;
			}
	...
	private static void jj_la1_init_0() {
		jj_la1_0 = new int[] { 0x2000000, 0x10000000, 0x4000000, 0x800000,
				0x100, 0x30800, 0x40000000, 0x400, 0x200000, 0x400000, 0x30800,
				0x30800, 0x10800, 0x30800, 0x0, };
	}

	private static void jj_la1_init_1() {
		jj_la1_1 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x19, 0x0, 0x0, 0x0,
				0x0, 0x1, 0x0, 0x0, 0x0, 0x18, };
	}
