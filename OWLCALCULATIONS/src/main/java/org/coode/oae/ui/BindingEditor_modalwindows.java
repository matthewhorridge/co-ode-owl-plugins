...
public class BindingEditor_modalwindows extends JPanel implements
	...
	protected final List<PropertyChainCell> propertyChainCells = new ArrayList<>();
	protected final VariableListModel<PropertyChainCell> propertychainsModel = new VariableListModel<>(
