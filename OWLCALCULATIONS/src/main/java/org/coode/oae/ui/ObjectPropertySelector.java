...
public class ObjectPropertySelector extends JPanel implements
	...
	protected List<OWLObjectProperty> objectProperties = new ArrayList<>();
	protected List<OWLClass> facetClasses = new ArrayList<>();
	protected StaticListModel<OWLObjectProperty> objectPropertiesModel = new StaticListModel<>(
			objectProperties, null);
	protected StaticListModel<OWLClass> facetClassesModel = new StaticListModel<>(
			facetClasses, null);
