...
public class BindingEditor extends JPanel implements VerifiedInputEditor,
	...
	public BindingEditor(OWLEditorKit k) {
		...
		this.editor = new ExpressionEditor<>(k,
		...
		PropertyChainAutoCompleter propertyChainAutoCompleter = new PropertyChainAutoCompleter(this.kit, this.editor, this.editor
