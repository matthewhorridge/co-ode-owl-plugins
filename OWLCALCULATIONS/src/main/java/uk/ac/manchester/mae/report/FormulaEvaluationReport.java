...
public class FormulaEvaluationReport {
    ...
    protected Set<IndividualEvaluationResult> results = new HashSet<>();
    ...
    public Set<OWLIndividual> getIndividuals() {
        ...
        for (IndividualEvaluationResult individualEvaluationResult : results) {
    ...
    public EvaluationResult getResult(OWLIndividual individual) {
        ...
        // boolean found = false;
        Iterator<IndividualEvaluationResult> it = results.iterator();
