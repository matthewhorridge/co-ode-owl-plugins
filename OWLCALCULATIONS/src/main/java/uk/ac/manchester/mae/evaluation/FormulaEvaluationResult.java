...
public class FormulaEvaluationResult {
    ...
    public Set<IndividualEvaluationResult> getIndividualEvaluationResults() {
        return individualEvaluationResults;
    }

    @Override
    public String toString() {
        StringBuilder toReturn = new StringBuilder(formula.toString());
        for (IndividualEvaluationResult i : individualEvaluationResults) {
            toReturn.append("\n");
            toReturn.append(i);
        }
