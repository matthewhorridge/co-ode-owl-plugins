...
public class ExceptionReportWriter extends FormulaReportWriter {
    ...
    public ExceptionReportWriter(OWLDataProperty dataProperty, MAEStart formula,
            Exception e) {
    ...
    public Object visitPropertyEvaluationReport(
        ...
        if (formula == null) {
            ...
            propertyEvaluationReport.getExceptions().add(exception);
        }
        return toReturn;
    }
    ...
    public Object visitFormulaEvaluationReport(
        ...
        formulaEvaluationReport.addException(exception);
        return null;
    }
}
