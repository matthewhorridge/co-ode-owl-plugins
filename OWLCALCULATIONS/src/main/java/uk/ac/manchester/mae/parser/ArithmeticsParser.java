...
public class ArithmeticsParser
        implements ArithmeticsParserTreeConstants, ArithmeticsParserConstants {
    ...
    private static void initCompletions(boolean conflictExpressed,
            boolean appliesToExpressed, boolean storeToExpressed,
        ...
        try {
            ...
            while (true) {
                ...
                if (t.image.equals(">") || t.image.equals("]")
                    ...
                    jjtn000.setContent(jjtn000.getContent()
                            + (jjtn000.getContent().equals("") ? "" : " ")
                            + t.image);
                    t = getNextToken();
                }
            }
            ...
            try {
                ...
                if (matcher != null) {
                    ...
                    List<String> kwMatches = new ArrayList<String>(
                            matches.size() + 10);
                    for (String s : e.getExpectedKeywords()) {
                        if (word.matches("(\u005c\u005cs)*") || s.toLowerCase()
    ...
    static void propertyChainExpression() throws ParseException {
    ...
    public static List<MAEpropertyChainCell> parsePropertyChain(String _text)
    ...
    private static String[] split(String text, String string,
    ...
    static final public void Binding(Set<String> variables)
            throws ParseException {
        /* @bgen(jjtree) Binding */
    ...
    static final public void Expression(Set<String> variables)
            throws ParseException {
        AdditiveExpression(variables);
    }

    static final public void AdditiveExpression(Set<String> variables)
            throws ParseException {
        Token op = null;
    ...
    static final public void MultiplicativeExpression(Set<String> variables)
            throws ParseException {
        Token op = null;
        ...
        try {
            ...
            label_3: while (true) {
                ...
                jjtn001.setMultiplication(
                        op == null || op.image.compareTo("*") == 0);
                jjtn001.setPercentage(
                        op != null && op.image.compareTo("%") == 0);
                MultiplicativeExpression(variables);
            }
        } catch (Throwable jjte001) {
    ...
    static final public void UnaryExpression(Set<String> variables)
            throws ParseException {
        if (jj_2_1(2)) {
            Power(variables);
        } else {
    ...
    static final public void Power(Set<String> variables)
            throws ParseException {
        /* @bgen(jjtree) Power */
    ...
    static final public void Function(Set<String> variables)
            throws ParseException {
        BigSum(variables);
    }

    static final public void BigSum(Set<String> variables)
            throws ParseException {
        /* @bgen(jjtree) BigSum */
    ...
    private static void jj_la1_init_0() {
        jj_la1_0 = new int[] { 0x2000000, 0x10000000, 0x4000000, 0x800000,
                0x100, 0x40030800, 0x200000, 0x400000, 0x40030800, 0x30800,
                0x10800, 0x30800, 0x0, };
    }

    private static void jj_la1_init_1() {
        jj_la1_1 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x6, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x6, };
    }
    ...
    static public void ReInit(java.io.InputStream stream, String encoding) {
        ...
        ArithmeticsParserTokenManager.ReInit(jj_input_stream);
        token = new Token();
        jj_ntk = -1;
        jjtree.reset();
        jj_gen = 0;
    ...
    static protected final class LookaheadSuccess extends java.lang.Error {
    ...
    static private boolean jj_scan_token(int kind) {
        if (jj_scanpos == jj_lastpos) {
            ...
            if (jj_scanpos.next == null) {
                jj_lastpos = jj_scanpos = jj_scanpos.next = ArithmeticsParserTokenManager
                        .getNextToken();
            } else {
