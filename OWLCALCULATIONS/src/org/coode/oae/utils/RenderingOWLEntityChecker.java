...
public class RenderingOWLEntityChecker implements OWLEntityChecker {
    ...
    public OWLDataProperty getOWLDataProperty(String name) {
        ...
        if (name.length() > 0 && toReturn == null) {
            toReturn = shortFormEntityChecker.getOWLDataProperty(iri
                    .getFragment());
        }
        if (toReturn == null) {
            toReturn = owlModelManager.getOWLDataFactory().getOWLDataProperty(
                    iri);
        }
		return toReturn;
	}
    ...
    public OWLNamedIndividual getOWLIndividual(String name) {
        ...
        if (name.length() > 0 && toReturn == null) {
            toReturn = shortFormEntityChecker.getOWLIndividual(iri
                    .getFragment());
        }
        if (toReturn == null) {
    ...
    public OWLObjectProperty getOWLObjectProperty(String name) {
        ...
        if (name.length() > 0 && toReturn == null) {
            toReturn = shortFormEntityChecker.getOWLObjectProperty(iri
                    .getFragment());
        }
        if (toReturn == null) {
            toReturn = owlModelManager.getOWLDataFactory()
    ...
    public OWLAnnotationProperty getOWLAnnotationProperty(String name) {
        ...
        if (name.length() > 0 && toReturn == null) {
            toReturn = shortFormEntityChecker.getOWLAnnotationProperty(iri
                    .getFragment());
        }
        if (toReturn == null) {
            toReturn = owlModelManager.getOWLDataFactory()
