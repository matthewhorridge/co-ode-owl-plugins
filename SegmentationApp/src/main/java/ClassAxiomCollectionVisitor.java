...
public class ClassAxiomCollectionVisitor extends OWLAxiomVisitorAdapter {
    ...
    private HashSet<OWLClassAxiom> classAxiomCollection = new HashSet<>();  //collection of all the axioms to be copied
    ...
    private HashSet<OWLDeclarationAxiom> declarationAxiomCollection = new HashSet<>();
    ...
    public void visit(OWLDisjointUnionAxiom axiom) {
        Set<OWLClassExpression> newAxiomDescription = new HashSet<>();
