...
public class ArithmeticsParser implements ArithmeticsParserTreeConstants,
	...
	static private OWLDataFactory dataFactory = OWLManager
		...
		try {
			...
			try {
				...
				if (matcher != null) {
					...
					Set<OWLObject> matches = matcher.getMatches(word, e
							.isClassNameExpected(), e
		...
		try {
			...
			label_3: while (true) {
				...
				jjtn001.setMultiplication(op == null
						|| op.image.compareTo("*") == 0);
				jjtn001.setPercentage(op != null
						&& op.image.compareTo("%") == 0);
				MultiplicativeExpression(variables);
			}
		} catch (Throwable jjte001) {
	...
	private static void jj_la1_init_1() {
		jj_la1_1 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x6, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x6, };
	}
