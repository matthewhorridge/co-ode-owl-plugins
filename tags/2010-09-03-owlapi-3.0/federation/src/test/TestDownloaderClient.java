...
public class TestDownloaderClient {
    ...
    private Long queryServer(OWLOntology ontologyURI) throws IOException {
        ...
        // Read stream from the server URL
    ...
    public static void main(String[] args) {
        ...
        //pools server as to most recent sequence number
        //compares with current sequence number
        //downloads list of those ChangeCapsules,
        //uses TagWriter to apply changes.
