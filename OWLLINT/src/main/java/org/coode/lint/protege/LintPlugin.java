 ...
 * 
 */
public final class LintPlugin implements
		ProtegePlugin<LintProtegePluginInstanceAdapter<?>> {
	 ...
	 */
	public LintProtegePluginInstanceAdapter<?> newInstance()
			throws ClassNotFoundException, IllegalAccessException,
			InstantiationException {
		ExtensionInstantiator<LintProtegePluginInstanceAdapter<?>> instantiator = new ExtensionInstantiator<>(
				this.extension);
		LintProtegePluginInstanceAdapter<?> lint = LintProtegePluginInstanceAdapter
				.buildLintProtegePluginInstanceAdapter(instantiator
