...
public interface LintConfiguration {
     ...
     *        {@link LintConfiguration#getPropertyKeys()}), this configuration
     *        will be unaffected.
     * @param value
     *        The value to assign.
     ...
     * 
     * @param key
     *        The input key. Cannot be @code{null}. If it does not belong to the
     *        Set of valid keys (see {@link LintConfiguration#getPropertyKeys()}
     *        ) {@code null} will be returned.
     ...
     * 
     * @param l
     *        The LintConfigurationChangeListener to add. Cannot be {@code null}
     *        .
     * @throws NullPointerException
