 ...
 */
public abstract class DefaultLintConfigurationChangeVisitorExAdapter<O>
        implements LintConfigurationChangeEventVisitorEx<O> {
     ...
     */
    @Override
    public O visitPropertyValueChanged(
