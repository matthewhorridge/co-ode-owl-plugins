...
public final class LintFactoryImpl implements LintFactory {
     ...
     */
    @Override
    public <O extends OWLObject> PatternBasedLint<O>
            createLint(Collection<? extends LintPattern<O>> lintPatterns) {
     ...
     */
    @Override
    public <O extends OWLObject> PatternReport<O>
            createPatternReport(LintPattern<O> pattern) {
        return new SimpleMatchBasedPatternReport<>(pattern);
    }
