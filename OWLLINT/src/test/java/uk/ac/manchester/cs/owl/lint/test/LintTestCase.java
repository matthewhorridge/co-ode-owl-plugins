...
public abstract class LintTestCase extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		IRI physicalIRI = IRI.create(this.getPhysicalOntologyIRIString());
		this.manager.loadOntologyFromOntologyDocument(physicalIRI);
		this.lint = this.createLint();
	}

	protected final OWLOntology getOntology(IRI iri) {
		OWLOntology toReturn = this.manager.getOntology(iri);
		if (toReturn == null) {
	...
	protected abstract String getPhysicalOntologyIRIString();
