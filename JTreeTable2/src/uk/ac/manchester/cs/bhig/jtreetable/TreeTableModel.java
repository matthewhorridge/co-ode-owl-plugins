...
public interface TreeTableModel<R> extends TableModel{
    ...
    Object getValueAt(R node, int column);

    void setValueAt(Object value, R node, int column);

    boolean isCellEditable(R node, int col);

    R getNodeForRow(int row);

    TableColumnModel getColumnModel();

    boolean addColumn(Object tc);

    void removeColumn(Object tc);
