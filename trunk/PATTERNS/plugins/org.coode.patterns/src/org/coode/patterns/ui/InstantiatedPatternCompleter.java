...
public class InstantiatedPatternCompleter {
	...
	public InstantiatedPatternCompleter(OWLEditorKit owlEditorKit,
		...
		this.keyListener = new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				InstantiatedPatternCompleter.this.processKeyPressed(e);
			}
			...
			public void keyReleased(KeyEvent e) {
				if (e.getKeyCode() != KeyEvent.VK_UP
					...
					if (InstantiatedPatternCompleter.this.popupWindow
							.isVisible()
							&& !InstantiatedPatternCompleter.this.lastTextUpdate
									.equals(InstantiatedPatternCompleter.this.textComponent
											.getText())) {
						InstantiatedPatternCompleter.this.lastTextUpdate = InstantiatedPatternCompleter.this.textComponent
								.getText();
						InstantiatedPatternCompleter.this
								.updatePopup(InstantiatedPatternCompleter.this
										.getMatches());
					}
				}
			}
		...
		this.textComponent.addHierarchyListener(new HierarchyListener() {
			...
			public void hierarchyChanged(HierarchyEvent e) {
				if ((e.getChangeFlags() & HierarchyEvent.PARENT_CHANGED) != 0) {
					InstantiatedPatternCompleter.this.createPopupWindow();
				}
			}
		});
	}
	...
	private List<? extends Object> getMatches() {
		PatternParser parser = ParserFactory.initParser(this.textComponent
