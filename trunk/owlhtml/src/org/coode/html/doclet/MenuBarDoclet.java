    ...
    private void renderOptions(URL pageURL, PrintWriter out) {
        ...
        if (isSingleFrameNavigation()){
            try {
                ...
                out.println("<a onclick=\"option('frames', 'true', '" + getServer().getBaseURL() + "?content=" + encodedURI + "');\">frames</a> | ");
            }
            ...
            out.println("<a onclick=\"option('frames', 'false', getContentURL());\">no frames</a> | ");
        }
        ...
        if (getServer().getNameRenderer().getClass().equals(FragmentShortFormProvider.class)){
            ...
            out.println("<a onclick=\"option('ren', '" + OWLHTMLConstants.RENDERER_LABEL + "', null);\">" + OWLHTMLConstants.RENDERER_LABEL + "</a>");
        }
        else{
            out.print("<a onclick=\"option('ren', '" + OWLHTMLConstants.RENDERER_FRAG + "', null);\">" + OWLHTMLConstants.RENDERER_FRAG + "</a>/");
