 ...
 */
public class AnnotationViewPrefs {
    ...
    private static AnnotationViewPrefs instance;
    ...
    public static AnnotationViewPrefs getInstance(){
        if (instance == null){
            instance = new AnnotationViewPrefs();
        }
        return instance;
    }
