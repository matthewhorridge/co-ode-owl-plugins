...
var ONT_SERVER = "/owldoc-server/"; // location from the root of the server

var BUSY_IMAGE = ONT_SERVER + "images/busy.gif";
...
function quickDescription(query){
...
function requestNewQueryElement(query){
