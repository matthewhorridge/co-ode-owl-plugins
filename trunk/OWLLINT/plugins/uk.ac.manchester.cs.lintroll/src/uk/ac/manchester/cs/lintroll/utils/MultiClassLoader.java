...
public abstract class MultiClassLoader extends ClassLoader {
	// ---------- Fields --------------------------------------
	private Hashtable<String, Class<? extends Object>> classes = new Hashtable<String, Class<? extends Object>>();
	 ...
	 */
	@Override
	public Class<? extends Object> loadClass(String className)
	...
	public synchronized Class<? extends Object> loadClass(String className,
		...
		byte[] classBytes;
		this.monitor(">> MultiClassLoader.loadClass(" + className + ", "
				+ resolveIt + ")");
	...
	protected String formatClassName(String className) {
		if (this.classNameReplacementChar == '\u0000') {
			...
			return className.replace('.', this.classNameReplacementChar)
					+ ".class";
		}
	}
