// $ANTLR 3.2 Sep 23, 2009 12:02:23 /Users/luigi/Documents/workspace/Parsers/src/OPPLLintTypes.g 2010-07-29 12:00:21
...
public class OPPLLintTypes extends TreeFilter {
    ...
    // /Users/luigi/Documents/workspace/Parsers/src/OPPLLintTypes.g:95:1: bottomup : lint ;
    public final void bottomup() throws RecognitionException {
        try {
            // /Users/luigi/Documents/workspace/Parsers/src/OPPLLintTypes.g:96:5: ( lint )
    ...
    // $ANTLR start "lint"
    // /Users/luigi/Documents/workspace/Parsers/src/OPPLLintTypes.g:101:1: lint : ^( OPPL_LINT IDENTIFIER ^(s= OPPL_STATEMENT ( . )* ) rc= returnClause ^( DESCRIPTION ( . )* ) ) ;
    public final OPPLLintTypes.lint_return lint() throws RecognitionException {
        ...
        OPPLSyntaxTree DESCRIPTION2=null;
        Variable rc = null;


        try {
            // /Users/luigi/Documents/workspace/Parsers/src/OPPLLintTypes.g:102:2: ( ^( OPPL_LINT IDENTIFIER ^(s= OPPL_STATEMENT ( . )* ) rc= returnClause ^( DESCRIPTION ( . )* ) ) )
            // /Users/luigi/Documents/workspace/Parsers/src/OPPLLintTypes.g:103:3: ^( OPPL_LINT IDENTIFIER ^(s= OPPL_STATEMENT ( . )* ) rc= returnClause ^( DESCRIPTION ( . )* ) )
            {
            match(input,OPPL_LINT,FOLLOW_OPPL_LINT_in_lint99); if (state.failed) return retval;

            match(input, Token.DOWN, null); if (state.failed) return retval;
            IDENTIFIER1=(OPPLSyntaxTree)match(input,IDENTIFIER,FOLLOW_IDENTIFIER_in_lint101); if (state.failed) return retval;
            s=(OPPLSyntaxTree)match(input,OPPL_STATEMENT,FOLLOW_OPPL_STATEMENT_in_lint108); if (state.failed) return retval;

            if ( input.LA(1)==Token.DOWN ) {
                match(input, Token.DOWN, null); if (state.failed) return retval;
                // /Users/luigi/Documents/workspace/Parsers/src/OPPLLintTypes.g:103:47: ( . )*
                loop1:
                do {
                    int alt1=2;
                    int LA1_0 = input.LA(1);

                    if ( ((LA1_0>=COMPOSITION && LA1_0<=DESCRIPTION)) ) {
                        alt1=1;
                    }
                    else if ( (LA1_0==UP) ) {
                        alt1=2;
            ...
            pushFollow(FOLLOW_returnClause_in_lint117);
            rc=returnClause();

            state._fsp--;
            if (state.failed) return retval;
            DESCRIPTION2=(OPPLSyntaxTree)match(input,DESCRIPTION,FOLLOW_DESCRIPTION_in_lint120); if (state.failed) return retval;

            if ( input.LA(1)==Token.DOWN ) {
                match(input, Token.DOWN, null); if (state.failed) return retval;
                // /Users/luigi/Documents/workspace/Parsers/src/OPPLLintTypes.g:103:82: ( . )*
                loop2:
                do {
                    int alt2=2;
                    int LA2_0 = input.LA(1);

                    if ( ((LA2_0>=COMPOSITION && LA2_0<=DESCRIPTION)) ) {
                        alt2=1;
                    }
                    else if ( (LA2_0==UP) ) {
                        alt2=2;
            ...
            if ( state.backtracking==1 ) {
              		  ...
              		  if(s.getOPPLContent() instanceof OPPLScript){
              			...
              			OPPLLintScript lint = this.getLintModelFactory().buildOPPLLintScript((IDENTIFIER1!=null?IDENTIFIER1.getText():null),
                                              (OPPLScript) s.getOPPLContent(),v,(DESCRIPTION2!=null?DESCRIPTION2.getText():null));
    ...
    // /Users/luigi/Documents/workspace/Parsers/src/OPPLLintTypes.g:117:1: returnClause returns [Variable variable] : ^( RETURN VARIABLE_NAME ) ;
    public final Variable returnClause() throws RecognitionException {
        ...
        try {
            // /Users/luigi/Documents/workspace/Parsers/src/OPPLLintTypes.g:118:3: ( ^( RETURN VARIABLE_NAME ) )
            // /Users/luigi/Documents/workspace/Parsers/src/OPPLLintTypes.g:119:7: ^( RETURN VARIABLE_NAME )
            {
            match(input,RETURN,FOLLOW_RETURN_in_returnClause156); if (state.failed) return variable;

            match(input, Token.DOWN, null); if (state.failed) return variable;
            VARIABLE_NAME3=(OPPLSyntaxTree)match(input,VARIABLE_NAME,FOLLOW_VARIABLE_NAME_in_returnClause158); if (state.failed) return variable;
    ...
    public static final BitSet FOLLOW_OPPL_LINT_in_lint99 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENTIFIER_in_lint101 = new BitSet(new long[]{0x0000000000000000L,0x0000080000000000L});
    public static final BitSet FOLLOW_OPPL_STATEMENT_in_lint108 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_returnClause_in_lint117 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000100000L});
    public static final BitSet FOLLOW_DESCRIPTION_in_lint120 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_RETURN_in_returnClause156 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_VARIABLE_NAME_in_returnClause158 = new BitSet(new long[]{0x0000000000000008L});
