 ...
 * <p/>
 */
public class ClassesByRestrCount extends AbstractClassCloudView {

    protected OWLCloudModel createModel() {
        return new ClassesByRestrCountModel(getOWLModelManager());
    }

    class ClassesByRestrCountModel extends AbstractClassCloudModel {
        protected ClassesByRestrCountModel(OWLModelManager mngr) {
            super(mngr);
        }
        ...
        protected int getValueForEntity(OWLClass entity) throws OWLException {
            ...
            for (OWLOntology ont : getOWLModelManager().getActiveOntologies()){
                count += entity.getSuperClasses(ont).size();
            }
            return count;
        }
